...
const CONFIG = {
    ...
    DEBUG: true, // Включить подробное логирование для отладки (true = все логи, false = только ошибки и предупреждения)
    VERBOSE_LOGGING: true, // Включить подробное логирование парсинга (true = все логи парсинга, false = только основные)
